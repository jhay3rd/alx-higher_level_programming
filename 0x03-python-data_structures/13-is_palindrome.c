...
*@head: header of listint_t
*Return: this contains the address of the new element, or NULL if it failed
*/
...
/**
*is_palindrome - identifies if a single linked list is a palindrome or not
